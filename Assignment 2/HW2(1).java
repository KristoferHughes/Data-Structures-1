package algs11;
//PLEASE NOTE: algs11 is written as package since I created this file inside algs11.
//"package algs11;" will need to be switched to "import algs11;" if file is put outside of it
...
class HW2 {
    ...
    public static double sumHelper (double[] arr, double tally, int i) {
    	if( i < arr.length){
    		tally= tally+arr[i];
    		return sumHelper (arr, tally, i + 1); 
    	}else return tally; 
    }
     ...
     * you saw:
     * 
     * OUTPUT: fibonacci(99)=-2437933049959450366
     *
